        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/5 pb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block sm:inline text-[#888] text-[10px] sm:text-[11px] sm:ml-2">AI CHATBOTS • CLINIC AGENTS • WEBSITE & APP DEV • SAP SD</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-[11px] text-[#999]">
          <div>
            ...
            <ul className="space-y-1">
              <li>• Autonomous AI Chatbots & RAG Agents</li>
