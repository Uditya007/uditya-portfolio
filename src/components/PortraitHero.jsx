...
export default function PortraitHero() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[600px] lg:w-[800px] h-[350px] sm:h-[600px] lg:h-[800px] bg-radial from-white/10 via-white/5 to-transparent rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="my-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center py-4 sm:py-6">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-left space-y-4 sm:space-y-5 z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 font-mono text-xs sm:text-[13px] tracking-wider text-white font-bold uppercase">
            ...
            <span className="text-[10px] text-[#27c93f] px-2 py-0.5 bg-[#27c93f]/10 border border-[#27c93f]/30 font-mono font-bold ml-auto sm:ml-0">
              AVAILABLE FOR HIRE
            </span>
          </div>
          ...
          <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-[58px] font-black tracking-[-0.04em] text-white uppercase leading-[0.95] font-display">
            ...
            <span className="block text-xs sm:text-sm lg:text-[15px] text-white/70 font-mono tracking-widest uppercase mt-2">
              EXPERT WEBSITES • MOBILE APPS (iOS & ANDROID)
            </span>
          </h1>

          {/* Specialized Clinic & Enterprise Highlight Pill */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#27c93f]/10 border border-[#27c93f]/40 text-[#27c93f] font-mono text-xs w-fit">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 font-mono text-xs">
            <a
              ...
              className="px-6 py-3 rounded-full bg-white hover:bg-[#e0e0e0] text-black font-bold transition-all shadow-[0_0_20px_rgba(255,255,255,0.25)] hover:scale-105 cursor-pointer flex items-center justify-center gap-2 text-center"
            >
            ...
            <a
              ...
              className="px-6 py-3 rounded-full bg-[#25d366] hover:bg-[#20ba59] text-white font-bold transition-all hover:scale-105 cursor-pointer flex items-center justify-center gap-2 text-center"
            >
        ...
        {/* RIGHT COLUMN (5 cols): High-Tech Engineering Telemetry & Spec Matrix Card */}
        <div className="lg:col-span-5 flex flex-col justify-center z-10">
          <div className="bg-[#121212] border border-white/15 p-6 sm:p-8 crosshair-corner shadow-2xl relative font-mono space-y-5">
            {/* Console Header */}
            <div className="flex items-center justify-between border-b border-white/10 pb-3 text-xs">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-white led-blink"></span>
                <span className="font-bold text-white uppercase tracking-wider">NODE_01 // CORE PROFILE</span>
              </div>
              <span className="text-[10px] text-[#27c93f] font-mono font-bold">STATUS: OPERATIONAL</span>
            </div>

            {/* Monogram Crest & Verified Title */}
            <div className="flex items-center gap-4 py-1">
              <div className="w-14 h-14 bg-white text-black font-black text-2xl flex items-center justify-center font-display shadow-lg shrink-0">
                US
              </div>
              <div>
                <h3 className="text-lg font-bold text-white uppercase font-display leading-tight">UDITYA SINGH</h3>
            ...
            <div className="space-y-2.5 text-xs border-t border-b border-white/10 py-4">
              <div className="flex justify-between items-center text-[#bbb]">
                <span className="text-[#888] flex items-center gap-1.5">
                  <Globe className="w-3.5 h-3.5 text-white" />
                  EXPERT WEBSITES
                </span>
                <span className="text-white font-bold">React • Next.js • 3D WebGL</span>
              </div>
              <div className="flex justify-between items-center text-[#bbb]">
                <span className="text-[#888] flex items-center gap-1.5">
              ...
              <div className="flex justify-between items-center text-[#bbb]">
                ...
                <span className="text-white font-bold">UK 🇬🇧 & Canada 🇨🇦 Voice/WA</span>
              </div>
              <div className="flex justify-between items-center text-[#bbb]">
                <span className="text-[#888] flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-2 gap-3 text-[11px] text-[#999] pt-1">
              <div className="bg-[#181818] p-2.5 border border-white/10">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-white/10">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => audio.playClick(1200)}
                  className="p-2 rounded border border-white/20 hover:border-white text-[#ccc] hover:text-white transition-all cursor-pointer"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => audio.playClick(1200)}
                  className="p-2 rounded border border-white/20 hover:border-[#0077b5] text-[#ccc] hover:text-[#0077b5] transition-all cursor-pointer"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => audio.playClick(1200)}
                  className="p-2 rounded border border-white/20 hover:border-[#ee2a7b] text-[#ccc] hover:text-[#ee2a7b] transition-all cursor-pointer"
                  title="Instagram"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => audio.playClick(1200)}
                  className="p-2 rounded border border-white/20 hover:border-[#25d366] text-[#ccc] hover:text-[#25d366] transition-all cursor-pointer"
